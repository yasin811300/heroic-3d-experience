<?php
/**
 * ربات تلگرام با Long Polling (بدون نیاز به Webhook)
 * این فایل رو با Cron Job هر 1 دقیقه اجرا کن
 */
...
// حذف Webhook (اگه تنظیم شده باشه)
deleteWebhook();

// دریافت آخرین Update ID از فایل
